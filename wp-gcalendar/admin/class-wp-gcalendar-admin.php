...
class Wp_Gcalendar_Admin {
	...
	public function wpgc_plugin_menu()
	{
		...
		add_submenu_page( 'google-calendar-plg', 'calendar Settings' . ' All Events', __( 'All Events', 'wp-gcalendar' ), 'manage_options','google-calendar-plg', 'wpgc_calendar_page');
		
		add_submenu_page('google-calendar-plg','Settings', __( 'Settings', 'wp-gcalendar' ), 'manage_options', 
						'google-calendar-settings', 'wpgc_settings');
		add_submenu_page('google-calendar-plg','Documentation', __( 'Documentation', 'wp-gcalendar' ), 'manage_options', 
